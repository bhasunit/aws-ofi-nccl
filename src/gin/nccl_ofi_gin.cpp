...
nccl_ofi_gin_comm::nccl_ofi_gin_comm(nccl_ofi_gin_resources &resources_arg, int dev_id_, int rank_,
				     int nranks_, nccl_net_ofi_send_comm_t *s_comm_,
				      ...
				      nccl_ofi_gin_comm **gin_comm_out)
{
	...
	nccl_ofi_gin_comm *gin_comm =
		new nccl_ofi_gin_comm(*resources, ep->get_domain().get_device()->dev_id, rank,
				      nranks, s_comm, r_comm, gin_ctx->get_device_copy_ctx());
